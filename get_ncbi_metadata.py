...
if __name__=="__main__":
    ...
    df['collection_date'] = df['collection_date'].apply(lambda x: x.split(' 00:00')[0] if ' 00:00' in x else x)
    ...
    ## add last 
    df = df[df['collection_date'] >='2022-01-01']
    df = df[df['isolation_source']=='city-wide wastewater treatment facility']
